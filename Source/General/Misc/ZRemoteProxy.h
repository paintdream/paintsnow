...
namespace PaintsNow {
	...
	class ZRemoteProxy : public TReflected<ZRemoteProxy, IReflectObjectComplex>, public IScript {
	public:
		...
		public:
			...
			void ApplyDelta(std::map<IScript::Object*, ObjectInfo>& info, const std::vector<std::pair<uint64_t, long> >& delta, bool retrieve);
