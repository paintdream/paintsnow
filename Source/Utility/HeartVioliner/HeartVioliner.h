...
#ifndef __HEARTVIOLINER_H__
#define __HEARTVIOLINER_H__
...
namespace PaintsNow {
	namespace NsHeartVioliner {
		...
		public:
			...
			HeartVioliner(IThread& thread, ITimer& factory, NsBridgeSunset::BridgeSunset& bridgeSunset);
