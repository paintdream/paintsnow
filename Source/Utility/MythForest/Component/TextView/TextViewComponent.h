...
namespace PaintsNow {
	...
	public:
		...
		TextViewComponent(TShared<FontResource> fontResource, TShared<MeshResource> meshResource, TShared<BatchComponent> batchComponent, const TShared<MaterialResource>& materialResource);
