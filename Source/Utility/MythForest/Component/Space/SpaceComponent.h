...
namespace PaintsNow {
	namespace NsMythForest {
		...
		public:
			...
			enum {
				SPACECOMPONENT_ATTACHED = COMPONENT_CUSTOM_BEGIN,
				SPACECOMPONENT_ORDERED = COMPONENT_CUSTOM_BEGIN << 1,
				SPACECOMPONENT_FORWARD_EVENT_TICK = COMPONENT_CUSTOM_BEGIN << 2,
				SPACECOMPONENT_CUSTOM_BEGIN = COMPONENT_CUSTOM_BEGIN << 3
			};
