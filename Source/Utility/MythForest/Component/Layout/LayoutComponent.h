...
#ifndef __LAYOUTCOMPONENT_H__
#define __LAYOUTCOMPONENT_H__
...
namespace PaintsNow {
	namespace NsMythForest {
		...
		class LayoutComponent : public TAllocatedTiny<LayoutComponent, UniqueComponent<Component, SLOT_LAYOUT_COMPONENT> > {
		public:
			enum {
